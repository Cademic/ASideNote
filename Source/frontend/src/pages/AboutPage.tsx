    ...
    <div className="landing-editorial bg-dots font-editorial flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="px-6 py-14 sm:py-20">
          ...
          <Reveal delay={400} className="mx-auto mt-12 flex max-w-4xl flex-wrap items-center justify-center gap-x-6 gap-y-4">
            <Link
              to={primaryHref}
          ...
          <Reveal delay={500}>
            <p className="mx-auto mt-14 max-w-4xl text-center text-sm text-[var(--land-ink-3)]">
              Built by{" "}
              <a
