    ...
    <div className="landing-editorial bg-dots font-editorial min-h-screen">
      ...
      <section className="px-6 py-14 sm:py-20">
        <div className="mx-auto max-w-xl">
          <div className="rotate-[-0.5deg] rounded-2xl border border-[var(--land-rule)] bg-[var(--land-paper)] p-8 text-center">
            <p className="text-[15px] leading-relaxed text-[var(--land-ink-2)]">
              ...
              feedback on a feature, or ran into a problem with your account, send us a message and
            ...
            <p className="mt-5 text-xs text-[var(--land-ink-3)]">
              For account-specific requests, include the email address on your ASideNote account so
              we can look you up faster.
            </p>
          </div>
