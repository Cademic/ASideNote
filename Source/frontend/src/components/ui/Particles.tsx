 ...
 * (no shadcn/`cn` dependency in this repo — otherwise unchanged canvas/mouse-magnetism logic).
 */
...
export function Particles({
  ...
  useEffect(() => {
    ...
    // Window resize alone misses height changes from the container's own
    // content growing (reveal animations, videos, images loading in) —
    // watch the container directly so the canvas always matches it.
  ...
  return (
    <div className={`pointer-events-none ${className}`} ref={canvasContainerRef} aria-hidden="true" {...props}>
