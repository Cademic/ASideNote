...
export function setProjectItemDragData(e: React.DragEvent, payload: ProjectItemDragPayload) {
  e.dataTransfer.setData(PROJECT_ITEM_DRAG_MIME, JSON.stringify(payload));
  e.dataTransfer.effectAllowed = "move";
}

export function getProjectItemDragPayload(e: React.DragEvent): ProjectItemDragPayload | null {
  try {
