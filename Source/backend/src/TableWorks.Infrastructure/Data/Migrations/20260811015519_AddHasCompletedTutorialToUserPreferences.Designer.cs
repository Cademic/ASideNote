...
namespace ASideNote.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260811015519_AddHasCompletedTutorialToUserPreferences")]
    partial class AddHasCompletedTutorialToUserPreferences
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASideNote.Core.Entities.BoardImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ASideNote.Core.Entities.Notebook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ASideNote.Core.Entities.NotebookVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ASideNote.Core.Entities.Project", b =>
                {
                    ...
                    b.Property<bool>("AutoProgressEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool?>("OwnerShowOnPersonalCalendar")
                        .HasColumnType("boolean");

                    b.Property<int>("Progress")
                        .HasColumnType("integer");

                    b.Property<bool>("ShowEventsOnMainCalendar")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ASideNote.Core.Entities.ProjectFolder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ASideNote.Core.Entities.ProjectMember", b =>
                {
                    ...
                    b.Property<bool?>("ShowOnPersonalCalendar")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ASideNote.Core.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("LastPresenceAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("LastSessionEndAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("ASideNote.Core.Entities.UserStorageItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ASideNote.Core.Entities.Board", b =>
                {
                    b.HasOne("ASideNote.Core.Entities.ProjectFolder", "ProjectFolder")
                        .WithMany("Boards")
            ...
            modelBuilder.Entity("ASideNote.Core.Entities.NotebookVersion", b =>
                {
                    b.HasOne("ASideNote.Core.Entities.Notebook", "Notebook")
                        .WithMany()
